...
import com.topolr.jpager.JmoduleContainer;
import com.topolr.jpager.JpageContainer;
import com.topolr.jpager.JpageController;
import com.topolr.jpager.annotation.PageMethod;
import com.topolr.jpager.annotation.PageTag;
import com.topolr.jpager.base.macro.Module;
import com.topolr.mvc.view.page.base.macro.Provider;
        ...
        public Jtemp(String tempName) throws Exception {
            try {
                ...
                if (e instanceof ParseException) {
                    ...
                    Logger.getLogger(Jtemp.class).info("[jpager] the template with name " + tempName + " parsed error." + e.getMessage());
                } else {
                    ...
                    kt.put("stackTrace", e.getStackTrace().toString());
                    this.append("Error", kt);
                    Logger.getLogger(Jtemp.class).info("[jpager] the template with name " + tempName + " can not find.");
                };
            }
        }
