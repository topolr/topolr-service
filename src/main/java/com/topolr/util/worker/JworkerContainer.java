package com.topolr.util.worker;

import com.topolr.timmer.JtimmerTask;
import com.topolr.util.worker.pool.CachePool;
import com.topolr.util.worker.pool.Fixedpool;
import com.topolr.util.worker.pool.SimplePool;
import com.topolr.util.worker.pool.SinglePool;
import com.topolr.util.worker.pool.schedule.SchedulePool;
...
public class JworkerContainer {
	...
	public static void main(String[] args) {
		JworkerContainer.getContainer().getSchedulePool()
				.addTask(new JtimmerTask(JtimmerTask.TIMMER_TYPE_CIRCLE, 5, 5) {
					@Override
					public void excute() {
