package com.topolr.util.base.string;

import com.topolr.util.base.Jdate;
import com.topolr.util.file.Jile;
import com.topolr.util.lib.DesUtils;
import com.topolr.util.lib.Md5;
...
public class Jstring {
    ...
    public static void main(String[] args) throws Exception {
		// System.out.println(Jstring.with("a,b,c,d,e,f").split(",").each(new
        // JstringEach() {
        // @Override
