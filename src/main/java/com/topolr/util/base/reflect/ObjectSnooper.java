package com.topolr.util.base.reflect;

import com.topolr.util.base.reflect.each.FieldAnnotaionEach;
import com.topolr.util.base.reflect.each.JannotaionEach;
import com.topolr.util.base.reflect.each.JconstructEach;
import com.topolr.util.base.reflect.each.JfieldEach;
import com.topolr.util.base.reflect.each.JmethodEach;
import com.topolr.util.base.reflect.each.MethodAnnotaionEach;
import com.topolr.util.base.reflect.test.Test;
import com.topolr.util.base.reflect.test.TestImp;
...
public class ObjectSnooper {
        ...
        while (cla != null) {
            try {
                ...
                if (null != k) {
                    field.setAccessible(true);
                    field.set(object,
                            this.getRightValue(field.getType(), value));
                    break;
                }
            } catch (Exception ex) {
                cla = cla.getSuperclass();
    ...
    public boolean hasFieldAnnotation(String fieldName, Class clazz)
    ...
    public boolean hasFieldAnnotations(String fieldName, Class clazz)
            throws NoSuchFieldException {
        boolean result = false;
        Class<?> cla = this.object.getClass();
        boolean isok = false;
    ...
    public ObjectSnooper fieldAnnotations(FieldAnnotaionEach each)
            throws Exception {
        Class<?> cla = this.object.getClass();
        for (Field field : cla.getDeclaredFields()) {
    ...
    public ObjectSnooper fieldAnnotationss(FieldAnnotaionEach each)
            throws Exception {
        Class<?> cla = this.object.getClass();
        boolean isok = false;
        while (cla != null) {
    ...
    public ObjectSnooper fieldAnnotaions(Class clazz, FieldAnnotaionEach each)
            throws Exception {
        Class<?> cla = this.object.getClass();
        for (Field field : cla.getDeclaredFields()) {
            Annotation[] cs = field.getDeclaredAnnotations();
    ...
    public ObjectSnooper fieldAnnotationss(Class clazz, FieldAnnotaionEach each)
            throws Exception {
        Class<?> cla = this.object.getClass();
        boolean isok = false;
        while (cla != null) {
    ...
    public ObjectSnooper fieldAnnotation(String fieldName, Class clazz,
            FieldAnnotaionEach each) throws NoSuchFieldException, Exception {
        Field field = this.object.getClass().getField(fieldName);
        Annotation[] annotations = field.getAnnotations();
        for (Annotation annotation : annotations) {
            if (annotation.annotationType() == clazz) {
    ...
    public ObjectSnooper fieldAnnotations(String fieldName, Class clazz,
            FieldAnnotaionEach each) throws NoSuchFieldException, Exception {
        Class<?> cla = this.object.getClass();
        boolean isok = false;
        while (cla != null) {
    ...
    public ObjectSnooper fieldAnnotations(String fieldName,
            FieldAnnotaionEach each) throws Exception {
        Field field = this.object.getClass().getField(fieldName);
        Annotation[] annotations = field.getAnnotations();
        for (Annotation annotation : annotations) {
            boolean isbreak = each.each(field, annotation);
    ...
    public ObjectSnooper fieldAnnotationss(String fieldName,
            FieldAnnotaionEach each) throws Exception {
        Class<?> cla = this.object.getClass();
        while (cla != null) {
    ...
    public boolean hasMethodAnnotations(Class clazz)
            throws NoSuchFieldException {
        boolean result = false;
        Class<?> cla = this.object.getClass();
        boolean issok = false;
    ...
    public ObjectSnooper mehodAnnotations(MethodAnnotaionEach each)
            throws Exception {
        Class<?> cla = this.object.getClass();
        for (Method field : cla.getDeclaredMethods()) {
            Annotation[] cs = field.getDeclaredAnnotations();
    ...
    public ObjectSnooper methodAnnotationss(MethodAnnotaionEach each)
            throws Exception {
        Class<?> cla = this.object.getClass();
        boolean isok = false;
        while (cla != null) {
    ...
    public ObjectSnooper methodAnnotaions(Class clazz, MethodAnnotaionEach each)
            throws Exception {
        Class<?> cla = this.object.getClass();
        for (Method field : cla.getDeclaredMethods()) {
            Annotation[] cs = field.getDeclaredAnnotations();
    ...
    public ObjectSnooper methodAnnotationss(Class clazz,
            MethodAnnotaionEach each) throws Exception {
        Class<?> cla = this.object.getClass();
        boolean isok = false;
        while (cla != null) {
            for (Method field : cla.getDeclaredMethods()) {
    ...
    public ObjectSnooper methodAnnotation(String fieldName, Class clazz,
            FieldAnnotaionEach each) throws NoSuchFieldException, Exception {
        Field field = this.object.getClass().getField(fieldName);
        Annotation[] annotations = field.getAnnotations();
        for (Annotation annotation : annotations) {
    ...
    public Object proxy(JwrapMethod deal) {
        ...
        return Proxy.newProxyInstance(this.object.getClass().getClassLoader(),
                this.object.getClass().getInterfaces(), deal);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        // ObjectSnooper.snoop(one).set("kk", null).sett("two",
        // "nnnnnn").methods(new JmethodEach() {
        // @Override
        ...
        Test test = (Test) ObjectSnooper.snoop(new TestImp()).proxy(
                new JwrapMethod() {
                    @Override
                    public void before() {
