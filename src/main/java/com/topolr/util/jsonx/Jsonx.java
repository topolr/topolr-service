...
public class Jsonx {
    ...
    private HashMap<String, Object> _toHashMap(JSONObject jsonObject) throws Exception {
        ...
        while (iterator.hasNext()) {
            String key = (String) iterator.next();
            String type = jsonObject.get(key).getClass().toString();
            if (type.contains("java.lang.String")) {
                ...
                result.put(key, jsonObject.getDouble(key));
            } else {
    ...
    private List<HashMap<String, Object>> _toList(JSONArray array)
            throws Exception {
    ...
    public List<Jsonx> find(String list, String key, String value)
            throws Exception {
        List<Jsonx> xlist = new ArrayList<Jsonx>();
    ...
    private void forit(Object k, String list, JsonFullEach each)
            throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        List<Jsonx> list = Jsonx
                .create(new File(
                                "H:\\java\\web\\Jdoc\\build\\web\\WEB-INF\\classes\\menumapping.json"))
                .find("list", "view", "wuliucom");
        for (Jsonx x : list) {
