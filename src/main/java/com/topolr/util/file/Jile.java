        ...
        if (this.file.exists()) {
            if (this.file.isDirectory()) {
                ...
                for (String tempList1 : tempList) {
                    ...
                    if (temp.isDirectory()) {
                        Jile.with(temp).browse(each);
                    } else {
                        isbreak = each.each(Jile.with(temp));
                        if (isbreak) {
                            break;
                        }
                    }
                ...
                isbreak = each.each(Jile.with(this.file));
            }
        }
        return this;
    }
