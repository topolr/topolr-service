...
import com.topolr.util.jxml.Jxml;
...
public class Jnode {
	...
	public Jnode(String tagName, HashMap<String, Object> attributes,
			Jnode parentNode) {
		this.tagName = tagName;
	...
	public void toFile(String filename, String version, String encode)
			throws Exception {
	...
	public void toOut(OutputStream out, String version, String encode)
			throws IOException {
		String x = this.getXML(version, encode);
		out.write(x.getBytes());
	}
