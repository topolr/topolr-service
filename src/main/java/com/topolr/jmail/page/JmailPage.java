...
import com.topolr.jmail.page.annotation.JmailMethod;
import com.topolr.jmail.page.annotation.JmailProvider;
import com.topolr.jmail.page.annotation.JmailTag;
import com.topolr.mvc.view.page.base.macro.IncludePage;
...
public class JmailPage {
    ...
    private JmailPage(Jsonx json) throws Exception {
        ...
        FileTemplateLoader loader = new FileTemplateLoader(new File(xmt.getParentFile().getAbsolutePath() + json.get("viewPath").toString()));
