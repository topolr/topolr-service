package com.topolr.mvc.view.page.base.macro;

import com.topolr.mvc.mapping.BaseMapping;
import com.topolr.mvc.view.page.Jspx;
import com.topolr.mvc.view.page.Jspx.Jtempx;
...
public class IncludePage implements TemplateDirectiveModel {
    ...
    public void execute(Environment e, Map map, TemplateModel[] tms, TemplateDirectiveBody tdb) throws TemplateException, IOException {
        ...
        try {
            ...
            page.appendData("httpPath", BaseMapping.mapping.get("projectHost").toString());
