...
import com.topolr.mvc.data.ModelSnooper;
import com.topolr.mvc.data.ModelSnooper.SQLInfo;
...
public class MysqlDao extends BaseDao {
    ...
    public <T> T query(T model) throws Exception {
        ...
        Logger.getLogger(MysqlDao.class).info("[query]"+info.getSQLString());
        Logger.getLogger(MysqlDao.class).info("[query]"+info.getValues());
    ...
    public <T> T insert(T model) throws Exception {
        ...
        Logger.getLogger(MysqlDao.class).info("[insert]"+info.getSQLString());
        Logger.getLogger(MysqlDao.class).info("[insert]"+info.getValues());
    ...
    public <T> T update(T model) throws Exception {
        ...
        Logger.getLogger(MysqlDao.class).info("[update]"+info.getSQLString());
        Logger.getLogger(MysqlDao.class).info("[update]"+info.getValues());
    ...
    public <T> T delete(T model) throws Exception {
        ...
        Logger.getLogger(MysqlDao.class).info("[delete]"+info.getSQLString());
        Logger.getLogger(MysqlDao.class).info("[delete]"+info.getValues());
    ...
    public RowList queryRowList(String sql, Object[] parameres) throws Exception {
        RowList rl = new RowList();
        rl.rows = this.queryList(sql, parameres);
        return rl;
    }
    ...
    public PageInfo queryPage(String sql, int from, int size, Object[] parlist) throws Exception {
        ...
        Logger.getLogger(MysqlDao.class).info(sql + ":" + print(parlist));
