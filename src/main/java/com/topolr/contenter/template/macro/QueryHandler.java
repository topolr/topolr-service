...
public class QueryHandler {
    ...
    public QueryHandler(HttpServletRequest request) {
    ...
    public QueryHandler reset() {
        this.queries = this.parseQuery(request.getQueryString());
        this.settingURL = this.currentURL;
        return this;
    }

    public QueryHandler setPath(String path) {
        this.settingURL = this.baseURL + path;
        return this;
    }

    public QueryHandler remove(String key) {
    ...
    public QueryHandler set(String key, String value) {
        this.queries.put(key, value);
        return this;
    }

    public QueryHandler empty() {
